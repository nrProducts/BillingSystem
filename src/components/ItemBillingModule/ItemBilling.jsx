...
const ItemBilling = ({ filteredItems, loader, itemColumns, selectedItems, search, setSearch, setSelectedItems, handleRemove, setViewMode, viewMode, getMenu, categoryList, selectedCategory, setSelectedCategory }) => {
